...
class SupplierCreate extends StatelessWidget {
  SupplierCreate({Key? key}) : super(key: key);

  final _formKey = GlobalKey<FormState>();

  late TextEditingController _kodeSupplier = TextEditingController(text: "");
  late TextEditingController _namaSupplier = TextEditingController(text: "");
  late TextEditingController _noTelephone = TextEditingController(text: "");
  late TextEditingController _alamat = TextEditingController(text: "");
  late TextEditingController _email = TextEditingController(text: "");
  late TextEditingController _namaSales = TextEditingController(text: "");
  late TextEditingController _noHandphone = TextEditingController(text: "");
  late TextEditingController _noRekening = TextEditingController(text: "");
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ApiResponseModel response = await api.create(
            token: token, endPoint: 'supplier', data: _supplierModel.toJson());
