...
class SideMenuTags extends StatelessWidget {
  const SideMenuTags({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    String assetsImage = Config().assetImage;
    return Column(
      children: [
        Row(
          children: [
            WebsafeSvg.asset(assetsImage + "icons/angle-down.svg", width: 16),
            SizedBox(width: kDefaultPadding / 4),
            WebsafeSvg.asset(assetsImage + "icons/markup.svg", width: 20),
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            WebsafeSvg.asset(
              assetsImage + "icons/markup-filled.svg",
              height: 18,
              color: color,
            ),
            SizedBox(width: kDefaultPadding / 2),
